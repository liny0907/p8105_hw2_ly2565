...
-   The trash wheel dataset contains 454 observations of 14 variables.
    Some key variables include weight\_tons, volume\_cubic\_yards,
    plastic\_bottles, polystyrene, cigarette\_butts, glass\_bottles,
    grocery\_bags, chip\_bags, sports\_balls, homes\_powered. The data
...
-   The `pols_month` dataset has 822 rows and 9 columns with variable
    ...
    sen\_dem, rep\_dem, president. The data on the number of national
    politicians at any given time was from 2015. In the `president`
    column, `dem` means the president at that given time was democratic,
    `gop` means the president at that time was republican.
...
-   The `unemployment` dataset has 816 rows and 3 columns with variable
    names: year, month, unemploy\_percent. The data on unemployment
    percentage was from 1948 to 2015. The highest unemployment
